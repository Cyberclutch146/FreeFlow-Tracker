...
const BudgetSchema = CollectionSchema(
  ...
  properties: {
    r'category': PropertySchema(
      ...
      enumMap: _BudgetcategoryEnumValueMap,
    ),
...
Budget _budgetDeserialize(
  ...
  final object = Budget(
    category:
        _BudgetcategoryValueEnumMap[reader.readStringOrNull(offsets[0])] ??
            Category.food,
    id: reader.readString(offsets[2]),
    month: reader.readLong(offsets[3]),
    monthlyLimit: reader.readDouble(offsets[4]),
...
P _budgetDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_BudgetcategoryValueEnumMap[reader.readStringOrNull(offset)] ??
          Category.food) as P;
    case 1:
...
const _BudgetcategoryEnumValueMap = {
  r'food': r'food',
...
const _BudgetcategoryValueEnumMap = {
...
extension BudgetQueryFilter on QueryBuilder<Budget, Budget, QFilterCondition> {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> hashCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hashCode',
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> hashCodeGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> hashCodeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> hashCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BudgetQuerySortBy on QueryBuilder<Budget, Budget, QSortBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQuerySortThenBy on QueryBuilder<Budget, Budget, QSortThenBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.desc);
    });
  }
...
extension BudgetQueryWhereDistinct on QueryBuilder<Budget, Budget, QDistinct> {
  ...
  QueryBuilder<Budget, Budget, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQueryProperty on QueryBuilder<Budget, Budget, QQueryProperty> {
  ...
  QueryBuilder<Budget, Category, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'category');
    });
  }

  QueryBuilder<Budget, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
