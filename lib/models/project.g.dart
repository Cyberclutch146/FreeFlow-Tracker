...
void _projectSerialize(
  ...
  writer.writeDouble(offsets[8], object.totalValue);
}
...
Project _projectDeserialize(
  ...
  final object = Project(
    ...
    status: _ProjectstatusValueEnumMap[reader.readStringOrNull(offsets[7])] ??
        ProjectStatus.ongoing,
    totalValue: reader.readDouble(offsets[8]),
  );
  return object;
}
...
const _ProjectstatusValueEnumMap = {
  r'ongoing': ProjectStatus.ongoing,
  r'completed': ProjectStatus.completed,
  r'unpaid': ProjectStatus.unpaid,
};
...
extension ProjectByIndex on IsarCollection<Project> {
  ...
  Future<List<Project?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<Project?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(Project object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(Project object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<Project> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<Project> objects, {bool saveLinks = true}) {
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> deadlineIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> deadlineIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> deadlineEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'deadline',
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> deadlineGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> deadlineLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> deadlineBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> totalValueEqualTo(
    double value, {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> totalValueGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> totalValueLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> totalValueBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByTotalValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalValue', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByTotalValueDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.desc);
    });
  }
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByTotalValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalValue', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByTotalValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalValue', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByDeadline() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByTotalValue() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, DateTime?, QQueryOperations> deadlineProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, double, QQueryOperations> totalValueProperty() {
    return QueryBuilder.apply(this, (query) {
